 ...
 *   - update: whether this is an update to mining power. Used for miningPowerField updates
 */
async function updateNftMiningPower(pool, nft, add, updatePoolTimestamp, accountOverride, update) {
